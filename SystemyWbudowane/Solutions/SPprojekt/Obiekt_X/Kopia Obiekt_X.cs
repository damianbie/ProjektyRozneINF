...
namespace Obiekty
{
    public class Obiekt_X : PictureBox
    {
        ...
        public void obliczObiekt(double Tc, ushort[] bout, ushort[] binp, ushort[] aout, ushort[] ainp)
        {
            ...
            if (K5) P_G1nom += 100.0;                    // Zwiêkszanie mocy grza³ki G3 (symulacja pokrêt³a)
            if (K6) P_G1nom -= 100.0;                    // Zmniejszanie mocy grza³ki G3 (symulacja pokrêt³a)
        ...
        public void rysujKlawisz(object sender, PaintEventArgs e, bool Kx, int x, int y)
        {
            ...
            Pen blackPen = new Pen(Color.Red, 1);                 // Pióro: czarny, gruboœæ:1
